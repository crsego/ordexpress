...
const fetchOrganization = async () => {
  ...
  try {
    ...
    const response = await axios.post(
      `${base_url}/api/Organizations/info`,
  ...
  const handleUpdateOrganization = async () => {
    ...
    try {
      ...
      await axios.put(`${base_url}/api/Organizations/${editingOrgId}`, updatedOrg, {
        headers: {
